...
<p class="text-center">already have an account ,<a href="<?php echo URLROOT ?>clients/login" class="btn btn-link">login here</a></p>
        ...
        <div class="col-lg-3 col-md-5 col-sm-12">
            <div class="card" style="width: 18rem; height: 400px;">
                ...
                <div class="card-body">
                    ...
                    <a href="<?php echo URLROOT ?>clients/login" class="card_btn">Book Now</a>
                </div>
            </div>
        </div>
...
<div class="container justify-content-center" style="margin-top: 100px;">
    <div class="row mt-5 gap-1">
        <div class="col-lg-7 col-md-5 col-sm-11">
            <img src="<?php echo URLROOT ?>img/img1.jpg" style="width: 100%; border-radius:10px; height:320px;" alt="">
        </div>
        <div class="col-lg-4 col-md-5 col-sm-11">
            <img src="<?php echo URLROOT ?>img/img2.jpg" style="width: 100%; border-radius:10px; height:320px;" alt="">
        </div>
        <div class="col-lg-4 col-md-5 col-sm-11">
            <img src="<?php echo URLROOT ?>img/img3.jpg" style="width: 100%; border-radius:10px; height:320px;" alt="">
        </div>
        <div class="col-lg-4 col-md-5 col-sm-11">
            <img src="<?php echo URLROOT ?>img/img4.jpg" style="width: 100%; border-radius:10px; height:320px;" alt="">
        </div>
        <div class="col-lg-3 col-md-5 col-sm-11">
            <img src="<?php echo URLROOT ?>img/img5.jpg" style="width: 100%; border-radius:10px; height:320px;" alt="">
        </div>
    </div>
</div>
