...
<p class="text-center">already have an account ,<a href="<?php echo URLROOT ?>users/login" class="btn btn-link">login here</a></p>
    ...
    <div class="row mt-5 gap-5 justify-content-center">
        ...
        <div class="col-lg-3 col-md-5 col-sm-12">
            <div class="card" style="width: 18rem; height: 400px;">
                ...
                <div class="card-body">
                    <h5 class="card-title">Cruise To Island</h5>
                    <a href="<?php URLROOT . 'port/index' ?>" class="card_btn">Book Now</a>
                </div>
            </div>
        </div>
